  ...
  render() {
    ...
    return (
      <div className="inner-portfolio-page">
        <Head title={"Techravity - GREENUT"} />
        <Navbar router={router} />
        <div className="banner-container">
          <div className="project-bg" style={{ backgroundColor: "#3fb758" }} />
          <div className="container">
            <div className="column">
              <img className="wow fadeIn logo" src="../../static/images/projects/logo/2.png" alt="GREENUT" />
              <h1>GREENUT</h1>
              <p>Greenut allows you to shop online at wholesale rate, anytime and anywhere with just a tap of your finger.</p>
            </div>
            <div className="column">
              <img style={{ width: "80%" }} className="wow fadeIn mockup" src="../../static/images/projects/2.png" alt="GREENUT" />
            </div>
          </div>
        </div>
        <div className="technology-container">
          ...
          <div className="column">
            ...
            <div className="items">
              <img src="../../static/images/technology/nodejs.svg" />
            </div>
            <div className="items">
              <img src="../../static/images/technology/mongodb.svg" />
            </div>
          </div>
        </div>
        <div className="porject-overview-container">
          <div className="container">
            <h2>Overview</h2>
            <p>
              Greenut allows you to shop online at wholesale rate, anytime and anywhere with just a tap of your finger. You can search for desired products.The App allows the user
              to view order details, track orders, save multiple addresses in address book, and check product ratings and reviews by other buyers.
            </p>
            <div className="overview-tabs">
              <div className="row">
                <div className="tabs">
                  <span className="header">Project name:</span>
                  <span className="content">Greenut</span>
                </div>
                <div className="tabs">
                  <span className="header">Services:</span>
                  <span className="content">IOS & App Development, UI/UX Design, DevOPs</span>
                </div>
                <div className="tabs">
                  <span className="header">Industry:</span>
                  <span className="content">E-commerce</span>
                </div>
              </div>
              <div className="row">
                <div className="tabs">
                ...
                <div className="tabs">
                  ...
                  <span className="content">React Native, Nodejs, Mongodb</span>
                </div>
                <div className="tabs">
        ...
        <div className="project-thumbnails">
          <div className="container">
            <div className="column">
              ...
              <p>
                ...
                Aesthetics and economics, technology and psychology are intrinsically related to the process.
              </p>
            </div>
          </div>
          <div className="gallery-container">
            <OwlCarousel className="items-container owl-carousel" events={events} options={options}>
              <div className="item">
                <img src="../../static/images/projects/sliders/2/1.jpg" alt="1" />
              </div>
              <div className="item">
                <img src="../../static/images/projects/sliders/2/4.jpg" alt="2" />
              </div>
              <div className="item">
                <img src="../../static/images/projects/sliders/2/3.jpg" alt="3" />
              </div>
            </OwlCarousel>
          </div>
        </div>
