  ...
  render() {
    ...
    return (
      <div className="inner-portfolio-page">
        <Head title={"Techravity - REACTCONF"} />
        <Navbar router={router} />
        <div className="banner-container">
          <div className="project-bg" style={{ backgroundColor: "#3640a2" }} />
          <div className="container">
            <div className="column">
              <img className="wow fadeIn logo" src="../../static/images/projects/logo/10.svg" alt="REACTCONF" />
              <h1>REACTCONF</h1>
              <p>ReactConf Iran is a Iranian web, mobile development & everything about javascript development event.</p>
              <a href="https://reactconf.ir/" target="_blank">
                website
              </a>
            </div>
            <div className="column">
              <img className="wow fadeIn mockup" src="../../static/images/projects/10.png" alt="REACTCONF" />
            </div>
          </div>
        </div>
            ...
            <div className="overview-tabs">
              <div className="row">
                <div className="tabs">
                  ...
                  <span className="content">ReactConf</span>
                </div>
                <div className="tabs">
                  <span className="header">Services:</span>
                  <span className="content">web and mobile development</span>
                </div>
                <div className="tabs">
              ...
              <div className="row">
                <div className="tabs">
                  ...
                  <span className="content">https://reactconf.ir/</span>
                </div>
                <div className="tabs">
                  <span className="header">Technologies:</span>
                  <span className="content">React, Nodejs, JS</span>
                </div>
                <div className="tabs">
        ...
        <div className="project-thumbnails">
          <div className="container">
            <div className="column">
              ...
              <p>
                Value Proposition Design is a 'must have' for anyone creating a new venture. It captures the core issues around understanding and finding customer problems and
                designing and validating potential solutions.
              </p>
            </div>
          </div>
          <div className="gallery-container">
            <OwlCarousel className="items-container owl-carousel" events={events} options={options}>
              <div className="item">
                <img src="../../static/images/projects/sliders/10/1.png" alt="1" />
              </div>
              <div className="item">
                <img src="../../static/images/projects/sliders/10/2.png" alt="2" />
              </div>
              <div className="item">
                <img src="../../static/images/projects/sliders/10/3.png" alt="3" />
              </div>
              <div className="item">
                <img src="../../static/images/projects/sliders/10/4.png" alt="4" />
              </div>
            </OwlCarousel>
          </div>
        </div>
