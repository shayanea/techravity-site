  ...
  render() {
    ...
    return (
      <div className="inner-portfolio-page">
        <Head title={"Techravity - SOCIETY ICON"} />
        <Navbar router={router} />
        <div className="banner-container">
          <div className="project-bg" style={{ backgroundColor: "#0091D6" }} />
          <div className="container">
            <div className="column">
              <img className="wow fadeIn logo" src="../../static/images/projects/logo/6.png" alt="SOCIETY ICON" />
              <h1>SOCIETY ICON</h1>
              <p>We believe that you as a person will be at the center of marketing in the future. The power of a person's social media has never been as high as it is today.</p>
              <a href="https://www.societyicon.com/" target="_blank">
                website
              </a>
            </div>
            <div className="column">
              <img style={{ width: "80%" }} className="wow fadeIn mockup" src="../../static/images/projects/6.png" alt="SOCIETY ICON" />
            </div>
          </div>
        </div>
        ...
        <div className="porject-overview-container">
          <div className="container">
            <h2>Overview</h2>
            <p>
              We believe that you as a person will be at the center of marketing in the future. The power of a person's social media has never been as high as it is today. We give
              people access to some of the world's largest brands through our platform.
            </p>
            <div className="overview-tabs">
              <div className="row">
                <div className="tabs">
                  <span className="header">Project name:</span>
                  <span className="content">SOCIETY ICON</span>
                </div>
                <div className="tabs">
                ...
                <div className="tabs">
                  ...
                  <span className="content">Event and Advertisement</span>
                </div>
              </div>
              <div className="row">
                <div className="tabs">
                  <span className="header">Website:</span>
                  <span className="content">https://www.societyicon.com/</span>
                </div>
                <div className="tabs">
                  <span className="header">Technologies:</span>
                  <span className="content">Swift, MySql, Asp.net</span>
                </div>
                <div className="tabs">
            ...
            <h2>Solution</h2>
            <p>
              Our belief is that you & me are the future of communication. We are different from other communities, in a way that makes it more efficient for the brand and more
              genuine for the influencer. Whether you have a huge crowd following you, or simply just your closest friends - we believe that you should be able to work with your
              favorite brand.
            </p>
          </div>
        </div>
        <div className="project-thumbnails">
          ...
          <div className="gallery-container">
            <OwlCarousel className="items-container owl-carousel" events={events} options={options}>
              <div className="item">
                <img src="../../static/images/projects/sliders/6/1.jpg" alt="1" />
              </div>
              <div className="item">
                <img src="../../static/images/projects/sliders/6/2.jpg" alt="2" />
              </div>
              <div className="item">
                <img src="../../static/images/projects/sliders/6/3.jpg" alt="3" />
              </div>
              <div className="item">
                <img src="../../static/images/projects/sliders/6/4.jpg" alt="4" />
              </div>
              <div className="item">
                <img src="../../static/images/projects/sliders/6/5.jpg" alt="4" />
              </div>
            </OwlCarousel>
          </div>
        </div>
