  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(InnerProject, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("div", {
        ...
        __self: this
      }, "South America & UK")))))), gallery.length && react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("div", {
        ...
        var slide = JSON.parse(items[item].slideShow),
            mock = slide.filter(function (item) {
          return item.type === 4;
        }),
            cover = slide.filter(function (item) {
          return item.type === 1;
        }),
            file = mock.length ? "http://192.168.1.76:8080".concat(mock[0].file) : "http://192.168.1.76:8080".concat(cover[0].file);
        console.log(slide);
...
//# sourceMappingURL=project.js.0e0191d3ee86750d9470.hot-update.js.map